...
*/
				?>
				<? if($arSection['DEPTH_LEVEL'] == 1 && $arSection['ID'] != 373) { ?>
					<h2 class="section_title"><? echo $arSection['NAME']; ?></h2>
				<? continue; } ?>
				
				<li id="<? echo $this->GetEditAreaId($arSection['ID']); ?>">
				<a href="<? echo $arSection['SECTION_PAGE_URL']; ?>" class="bx_catalog_line_img" style="bbackground-image: url(<? echo $arSection['PICTURE']['SRC']; ?>);">
					<? if (false !== $arSection['PICTURE']) { ?>
