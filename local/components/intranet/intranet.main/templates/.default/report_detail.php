...
<div class="pull-right">
	<a href="/intranet/reports?action=adopted_report&repel=1&report_id=<?=$arResult['REPORT']['ID']?>" class="btn btn-default btn-danger"><span class="glyphicon glyphicon-remove"></span> Отклонить</a>
	<a href="/intranet/reports?action=adopted_report&report_id=<?=$arResult['REPORT']['ID']?>" class="btn btn-default btn-success"><span class="glyphicon glyphicon-ok"></span> Принять</a>
</div>
<div class="clear"></div>
<h3>Комментарии</h3>
<div class="row">
