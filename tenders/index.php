...
?>
<?
//echo Korting::getInstance()->GetUserCompanyID();
global $USER;
...
global $tenders_filter;

$tenders_filter	= array();

$tenders_filter['PROPERTY_COMPANY']	= array(false, $arUser['UF_WORK_COMPANY']);
...
<? $APPLICATION->IncludeComponent("bitrix:news.list", "tenders", Array(
	...
	"FILTER_NAME" => "tenders_filter",	// Фильтр
