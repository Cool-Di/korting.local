...
//	$arFilter['UF_COURSE_COMPANY']	= array(false, $arParams['USER_COMPANY_ID']);
//	$arFilter['UF_COURSE_COMPANY']	= false;
//	dump($arFilter);
	if(isset($arParams['ADD_FILTER']) && is_array($arParams['ADD_FILTER']))
	{
